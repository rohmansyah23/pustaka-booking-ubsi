...
<a class="scroll-to-top rounded" href="#page-top"> <i class="fas fa-angleup"></i> </a>
<!-- Logout Modal-->
<div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" arialabelledby="exampleModalLabel" aria-hidden="true"> <div class="modaldialog" role="document">
