      ...
      <div class="card border-left-danger shadow h-100 py-2 bg-primary">
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              <div class="text-md font-weight-bold text-white text-uppercase mb-1">Jumlah Member Aktif</div>
              <div class="h1 mb-0 font-weight-bold text-white"><?= $this->ModelUser->getUserWhereIn([2])->num_rows(); ?></div>
            </div>
            <div class="col-auto">
  ...
  <div class="row">
    ...
    <tbody>
        ...
        foreach ($anggota as $a) {
            if ($a['role_id'] == 2) { // Hanya menampilkan data dengan role_id 2
        ?>
                <tr>
                    <td><?= $i++; ?></td>
                    <td><?= $a['nama']; ?></td>
