...
class Admin extends CI_Controller {
    ...
    public function index() {
        ...
        foreach ($detail as $key) {
            ...
            if ($beda->days > 2) {
                $this->db->query("UPDATE buku SET stok=stok+1, dibooking=dibooking1 WHERE id='$id_buku'");
            }
        }
   ...
   public function member()
{
    ...
    // Menggunakan where_in() untuk mengambil data pengguna dengan role_id yang ada dalam array
    $role_ids = [1, 2]; // Array role_id yang ingin ditampilkan
    $data['member'] = $this->ModelUser->getUserWhereIn($role_ids)->result_array(); // Menggunakan ModelUser untuk mengambil data
    $this->load->view('admin/index', $data); // Ganti 'nama_view' dengan nama view yang Anda gunakan
}
